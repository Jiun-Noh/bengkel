...
export function cetakNota(data) {
  ...
  let nota = `<html><head><style>body{font-family:Courier New; font-size:13px; width:280px; padding:10px; margin:0 auto;}.tengah{text-align:center; white-space:nowrap;}.kanan{text-align:right; white-space:nowrap;}.garis{border-bottom:1px dashed #000; margin:6px 0;}table{width:100%; border-collapse:collapse; font-size:12px;}</style></head><body><div class="tengah"><h3 style="margin:4px 0;">📦 BENGKEL MOTOR</h3><p style="margin:4px 0; font-size:12px;">Jl. Contoh Alamat Denpasar</p><p style="margin:4px 0; font-size:12px;">Telp: 08xx-xxxx-xxxx</p></div><div class="garis"></div><p>Tanggal: ${data.tgl}</p><p>Pelanggan: ${data.namaPelanggan}</p><p>📱 HP: ${data.nomorHP || '-'}</p><p>Plat/Motor: ${data.platKendaraan} / ${data.jenisMotor}</p><div class="garis"></div><table><tr><td><strong>URAIAN</strong></td><td class="tengah"><strong>JUMLAH</strong></td><td class="kanan"><strong>SUBTOTAL</strong></td></tr><tr><td colspan="3"><div class="garis"></div></td></tr>`
